...
Members must meet the required criteria to send messages in Text Spaces or start direct messages. This rule does not apply to members with assigned roles if Nexus onboarding is disabled. We recommend enabling a verification level for the Community Nexus. Lean more.          </Text>
        ...
        <View style={{ marginTop: 22 }}>
          ...
          <Text style={styles.pillDesc}>
Select whether Nexus members are allowed to share image-based media flagged by Ballastra’s sensitive content filters. This setting applies only to Spaces that are not age-restricted. Lean more.          </Text>
        ...
        <View style={{ marginTop: 22 }}>
          ...
          <Text style={styles.pillDesc}>
Users will need to confirm they are over the legal age to view the content in this Nexus. Lean more.          </Text>
        </View>
