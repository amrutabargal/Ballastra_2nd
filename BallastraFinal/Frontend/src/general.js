      ...
      <View style={styles.sheetWrapper}>
        ...
        >
          ...
          <View style={styles.settingsBlock}>
            ...
            {/* Mute Space - Navigate to MuteSpaceScreen */}
            <TouchableOpacity
              activeOpacity={0.8}
              style={styles.settingsItem}
              onPress={() => navigation.navigate("MuteSpaceScreen", { spaceName: "Chat Space" })}
            >
            ...
            {/* Notification Settings - Navigate to NotificationSettingsScreen */}
            <TouchableOpacity
              activeOpacity={0.8}
              style={styles.settingsItem}
              onPress={() => navigation.navigate("NotificationSettingsScreen", { spaceName: "Chat Space" })}
            >
