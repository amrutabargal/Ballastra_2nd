...
export default function NexusCommunityScreen({ navigation }) {
  ...
  const handleTabPress = (tab) => {
    if (tab === "setting") {
      navigation.navigate("NexusSettings");
    } else if (tab === "management") {
      navigation.navigate("V31");
    }
  };

  // ✅ REAL NAVIGATION
  const handleRowPress = (routeName) => {
        ...
        <View style={styles.mainCard}>
          ...
          <View style={styles.communityList}>
            <CommunityRow
              icon="megaphone-outline"
              label="Announcements"
              onPress={() => handleRowPress("AnnouncementsScreen")}
            />
            <CommunityRow
              icon="compass-outline"
              label="Space Discovery"
              onPress={() => handleRowPress("SpaceDiscoveryScreen")}
            />
            <CommunityRow
              icon="pricetags-outline"
              label="Community Tags"
              onPress={() => handleRowPress("CommunityTagsScreen")}
            />
            <CommunityRow
              icon="mail-unread-outline"
              label="Welcome Message"
              onPress={() => handleRowPress("WelcomeMessageScreen")}
            />
            <CommunityRow
              icon="log-in-outline"
              label="Auto-Ident on Join"
              onPress={() => handleRowPress("AutoIdentScreen")}
            />
            <CommunityRow
              icon="book-outline"
              label="Rules & Guidelines"
              onPress={() => handleRowPress("RulesGuidelinesScreen")}
            />
            <CommunityRow
              icon="bar-chart-outline"
              label="Community Insights"
              onPress={() => handleRowPress("CommunityInsightsScreen")}
              showBottomDivider={false}
            />
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  fakeStatusIcons: { flexDirection: "row", gap: 6 },
  ...
  statsRow: { marginTop: 6, flexDirection: "row", alignItems: "center" },
  ...
  tabItemActive: { backgroundColor: "#08152B" },
