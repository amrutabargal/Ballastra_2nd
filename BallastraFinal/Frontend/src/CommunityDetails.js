...
// const USER_IMAGE = 'https://i.pravatar.cc/150?img=1';
...
//         {/* 🔁 ONLY CHANGE: IMAGE INSTEAD OF EMOJI */}
//         <TouchableOpacity style={styles.sushiWrapper}>
//           <View style={styles.sushiInner}>
//             <Image source={{ uri: USER_IMAGE }} style={styles.sidebarAvatar} />
//           </View>
//         </TouchableOpacity>
//       </View>
...
//                     navigation.navigate('CategorySettingsFlow', {
...
// /* ===== STYLES (UNCHANGED, ONLY IMAGE SUPPORT ADDED) ===== */
            ...
            {chatSpaceExpanded && (
              <>
                ...
                <TouchableOpacity
                  ...
                  onLongPress={() => navigation.navigate('general')}
                  delayLongPress={300}
                >
                  {activeChatChannel === 'general' && (
                    <View style={styles.activeIndicator} />
